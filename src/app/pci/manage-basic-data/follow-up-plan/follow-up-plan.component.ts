...
export class FollowUpPlanComponent implements OnInit {
  ...
  followUpPlanTable2: TableOption = new TableOption();
  followUpPlanTable3: TableOption = new TableOption();
  followUpPlanTable4: TableOption = new TableOption();
  followUpPlanTable5: TableOption = new TableOption();
  discomfortTypes: any;
